    ...
    public function save(){
       if($this->request->isAjax()){
          ...
          if(!is_string(input('pclogo'))){
              ...
              $data['pclogo']=uploads(Request::instance()->file('pclogo'));
          }
          if(!is_string(input('pclogos'))){
          
              $data['pclogos']=uploads(Request::instance()->file('pclogos'));
          }
          if(!is_string(input('waplogo'))){
              $data['waplogo']=uploads(Request::instance()->file('waplogo'));
          }
          if(!is_string(input('qrcode'))){
              $data['qrcode']=uploads(Request::instance()->file('qrcode'));
          }
          if(!is_string(input('wx'))){
           ...
           $data['url']=input('url');
           $data['qq']=input('qq');
           $data['service_wx']=input('service_wx');
